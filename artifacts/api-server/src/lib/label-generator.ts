...
• ALCOHOL CONTENT — ABV percentage with unit and/or proof. Many formats are valid: "45% Alc./Vol.", "40% alc./vol. (80 Proof)", "ALC. 15.5% BY VOL.", "ALC 40% BY VOL", "13.5% alc/vol", "6% alcohol by volume", "40% ABV", "38% vol", "40 percent alcohol". Any number followed by %, ABV, alc, vol, or proof qualifies.
